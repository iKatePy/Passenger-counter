...
Убедитесь, что label.txt находится в data/ и в нем привсутствует маркировка название видео кол-во входящих людей, кол-во выходящих людей, тип видео (если нужно). Пример "FrontDoorCam.mp4 3 4 0"
